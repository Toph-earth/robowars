...
class _TeamScreenState extends State<TeamScreen> {
      ...
      actions: [
        Padding(
          ...
          child: GestureDetector(
            ...
            child: const Icon(Icons.groups, color: Color(0xFF9C49E2), size: 35),
          ),
        ),
      ],
    );
        ...
        Container(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final bots =
                  (List<Map<String, dynamic>>.from(team['bots'])
                  ...
                  child: SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          // This Expanded is now properly placed
                          child: Column(
  ...
  Widget _buildTableView() => Padding(
    ...
    child: ListView.builder(
      padding: const EdgeInsets.only(bottom: 100), // Add this line
      itemCount: teamsData.length,
      itemBuilder: (context, index) {
        return Container(
